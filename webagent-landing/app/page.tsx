      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-blue-50">
        ...
        <div className="relative container-custom section-padding">
          <div className="text-center max-w-5xl mx-auto">
            ...
            {/* Sub-headline */}
            <p
              className="text-xl md:text-2xl lg:text-3xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed animate-slide-up"
            ...
            {/* Trust Indicators */}
            <div
              className="mt-16 flex flex-col sm:flex-row items-center justify-center space-y-4 sm:space-y-0 sm:space-x-8 text-sm text-gray-500 animate-fade-in"
        ...
        ></div>
        <div
          className="absolute bottom-20 left-20 w-12 h-12 bg-green-200 rounded-full opacity-20 animate-float"
        ...
        <div className="container-custom">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Watch WebAgent understand, plan, and execute complex web tasks in
              real-time. This is the future of web automation.
            </p>
          </div>
      ...
      <section className="section-padding bg-white">
        <div className="container-custom">
          <div className="text-center mb-20">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              WebAgent combines advanced AI with secure execution to deliver
              unprecedented web automation capabilities.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="text-center group card-hover">
              ...
              <p className="text-gray-600 leading-relaxed">
                Goes beyond simple scraping to understand the content and
                function of any webpage. WebAgent sees the web like a human
                does.
              </p>
            </div>
            ...
            <div className="text-center group card-hover">
              ...
              <p className="text-gray-600 leading-relaxed">
                Dynamically generates a strategic, step-by-step plan to achieve
                any high-level goal. Intelligence that adapts to any scenario.
              </p>
            </div>
            ...
            <div className="text-center group card-hover">
              ...
              <p className="text-gray-600 leading-relaxed">
                Executes plans in a hardened browser, with every critical action
                approved by you. Power with complete control and security.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container-custom">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-12 leading-relaxed">
              ...
              ,
              <span className="text-purple-400 font-semibold"> Zero Trust</span>{" "}
              architecture to ensure your data and credentials are kept
            ...
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6">
                ...
                <p className="text-gray-400 text-sm">
                  We never see your data or credentials
                </p>
              </div>
              <div className="bg-white/5 backdrop-blur-sm rounded-xl p-6">
        ...
        <div className="container-custom">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-12">
              Join the private beta and be among the first to harness the power
              of truly autonomous web agents.
            </p>
            ...
            {!isSubmitted ? (
              ...
              <div className="max-w-md mx-auto bg-green-50 border border-green-200 rounded-lg p-8">
                ...
                <p className="text-green-700">
                  We'll be in touch soon with your private beta access. Get
