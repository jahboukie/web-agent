...
class EnterpriseSessionManager:
    ...
    def __init__(self):
        ...
        self.session_timeout = (
            getattr(settings, "MAX_SESSION_DURATION_HOURS", 24) * 3600
        )
    ...
    def _calculate_device_fingerprint(
        self, user_agent: str, additional_headers: dict[str, str] = None
    ) -> str:
    ...
    async def create_session(
        ...
        try:
            ...
            session_info = SessionInfo(
                ...
                device_fingerprint=self._calculate_device_fingerprint(
                    user_agent, additional_headers
                ),
    ...
    async def _rotate_session(self, session_info: SessionInfo) -> bool:
        ...
        try:
            ...
            logger.debug(
                "Session keys rotated", session_id=session_info.session_id[:12]
            )
        ...
        try:
            ...
            while True:
                cursor, keys = await self.redis_client.scan(
                    cursor=cursor, match=f"{self.session_prefix}*", count=100
                )
...
enterprise_session_manager: EnterpriseSessionManager | None = None
