...
class ExecutionResponse(BaseModel):
    ...
    estimated_duration_seconds: Optional[int] = Field(
        default=None,
        description="Estimated time to complete execution"
    )
...
class ExecutionStatusResponse(BaseModel):
    ...
    completed_at: Optional[str] = Field(
        default=None,
        description="When execution completed (ISO format)"
    )
...
class ActionResult(BaseModel):
    ...
    before_screenshot: Optional[str] = Field(
        default=None,
        description="Screenshot path before action"
    )
    after_screenshot: Optional[str] = Field(
        default=None,
        description="Screenshot path after action"
    )
    target_selector: Optional[str] = Field(
        default=None,
        description="Element selector used for the action"
    )
    input_value: Optional[str] = Field(
        default=None,
        description="Input value used for the action"
    )
