...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: list[str] = [
        "https://www.webagentapp.com",
        "https://webagentapp.com",
        "https://api.webagentapp.com",
        "http://localhost:3000",
        "http://localhost:8080",
    ]
    ...
    WEBAGENT_ADMIN_PASSWORD: str | None = None
    WEBAGENT_TEST_PASSWORD: str | None = None
    ...
    HSM_PROVIDER: str | None = None  # "aws_cloudhsm", "azure_keyvault", "google_hsm"
    HSM_CLUSTER_ID: str | None = None
    AWS_KMS_KEY_ID: str | None = None
    AZURE_KEY_VAULT_URL: str | None = None
    GCP_KMS_PROJECT_ID: str | None = None
    ...
    INCIDENT_RESPONSE_EMAIL: str | None = None
    ...
    SIEM_INTEGRATION_URL: str | None = None
    SIEM_API_KEY: str | None = None
    SIEM_USERNAME: str | None = None
    SIEM_PASSWORD: str | None = None
    SIEM_PROVIDER: str = (
        "splunk"  # "splunk", "qradar", "microsoft_sentinel", "elastic_security"
    )
    ...
    AZURE_LOG_ANALYTICS_SHARED_KEY: str | None = None
    ...
    def is_enterprise_mode(self) -> bool:
        ...
        return (
            self.ENABLE_ZERO_KNOWLEDGE and self.ENABLE_ZERO_TRUST and self.REQUIRE_MFA
        )
