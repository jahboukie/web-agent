...
class User(Base):
    ...
    sso_user_id: Mapped[str | None] = mapped_column(String(255), nullable=True, index=True)
    ...
    data_classification: Mapped[str | None] = mapped_column(String(50), default="internal")
