...
from app.schemas.enterprise import (
    EnterpriseTenantCreate, EnterpriseTenantUpdate, EnterpriseTenant as TenantSchema
)
...
class EnterpriseTenantService:
    ...
    async def get_tenant(
        ...
        try:
            ...
            if tenant_id:
                ...
                raise ValueError("Must provide tenant_id, tenant_external_id, or domain")
    ...
    async def list_tenants(
        ...
        try:
            ...
            if compliance_level:
                query = query.where(EnterpriseTenant.compliance_level == compliance_level)
            
            query = query.offset(skip).limit(limit).order_by(EnterpriseTenant.created_at.desc())
    ...
    async def get_tenant_users(
        ...
        try:
            query = select(User).join(
                user_tenant_roles,
                User.id == user_tenant_roles.c.user_id
            ).where(
    ...
    async def get_tenant_stats(
        ...
        try:
            ...
            return {
                ...
                "user_utilization": (user_count / tenant.max_users * 100) if tenant.max_users > 0 else 0,
        ...
        try:
            ...
            if check_type == "users":
                ...
                return {
                    ...
                    "utilization_percent": (current_users / tenant.max_users * 100) if tenant.max_users > 0 else 0,
                    "at_limit": current_users >= tenant.max_users,
                    "near_limit": current_users >= (tenant.max_users * 0.9) if tenant.max_users > 0 else False
                }
    ...
    async def deactivate_tenant(
        ...
        try:
            ...
            logger.info(f"Deactivated tenant: {tenant.tenant_id} by user {deactivated_by}")
            return True
