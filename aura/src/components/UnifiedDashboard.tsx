...
> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    ...
    if (process.env.NODE_ENV === "development") {
      console.warn("Dashboard Issue:", error, errorInfo);
    }
  }
  ...
  <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
    <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
      ...
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        {error.message ||
          "An unexpected issue occurred while loading the dashboard"}
      </p>
      <button
        onClick={retry}
...
export function UnifiedDashboard() {
  ...
  const hasAccessToView = useCallback(
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-gray-900 p-4">
        <div className="max-w-md w-full bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Unable to connect to WebAgent services. Please check your connection
            and try again.
          </p>
          <button
                ...
                <div className="flex items-center space-x-3">
                  <div className="hidden sm:block text-right">
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">
                      {PRICING_TIERS.find(
                        (t) => t.id === state.stats?.subscription.tier,
                      )?.name || "Free"}
                    </p>
                  </div>
                  ...
                  return (
                    <div key={item.id} className="relative">
                      <button
                        type="button"
                        onClick={() =>
                          hasAccess ? handleViewChange(item.id) : null
                        }
                        disabled={!hasAccess}
                        className={cn(
      ...
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Website intelligence and data extraction
          </p>
        </div>
      </div>
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            AI-powered workflow planning and automation strategy
          </p>
        </div>
      </div>
    ...
    <div className="p-6 space-y-6 max-w-7xl mx-auto">
      <div className="flex items-center space-x-3 mb-6">
        ...
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400">
            Automation execution and workflow monitoring
          </p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="space-y-2">
              {[
                { issue: "Element Not Found", recovery: 94 },
                { issue: "Timeout Exceeded", recovery: 87 },
                { issue: "Network Issues", recovery: 91 },
                { issue: "Validation Failures", recovery: 89 },
              ].map((item) => (
                <div
                  key={item.issue}
                  className="flex items-center justify-between"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Generate detailed performance and efficiency reports
            </p>
          </button>
          ...
          <button className="p-4 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors text-left">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">
              Monitor automation goals and KPI achievement
            </p>
          </button>
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-4">
      <div className="flex items-center justify-between mb-3">
        ...
        {change && trend && (
          ...
          >
            <TrendingUp
              className={cn("h-3 w-3 mr-1", trend === "down" && "rotate-180")}
            />
            {change}
          </div>
        )}
      ...
      {executionResult && (
        <div className="space-y-4">
          <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
            ...
            <div className="text-sm text-green-600 dark:text-green-300">
              Completed in {executionResult.duration} •{" "}
              {executionResult.actions_performed} actions performed
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900 dark:text-white">
                  {executionResult.steps_completed}/{selectedPlan.steps}
                </p>
              </div>
              <div>
                <span className="text-gray-600 dark:text-gray-400">
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <span className="text-sm font-medium">
                  {executionResult.data_extracted.forms_filled}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <span className="text-sm font-medium">
                  {executionResult.data_extracted.elements_clicked}
                </span>
              </div>
              <div className="flex justify-between items-center">
                <span className="text-sm text-gray-600 dark:text-gray-400">
                ...
                <span className="text-sm font-medium">
                  {executionResult.data_extracted.pages_visited}
                </span>
              </div>
            </div>
          </div>
    ...
    try {
      ...
      const mockPlan = {
        ...
        steps: [
          {
            step: 1,
            action: "Navigate to target website",
            type: "navigation",
            confidence: 98,
          },
          {
            step: 2,
            action: "Locate and analyze form elements",
            type: "analysis",
            confidence: 95,
          },
          {
            step: 3,
            action: "Fill form fields with provided data",
            type: "interaction",
            confidence: 92,
          },
          {
            step: 4,
            action: "Submit form and verify success",
            type: "validation",
            confidence: 89,
          },
        ],
      ...
      setError(
        err instanceof Error ? err.message : "Failed to create automation plan",
      );
    } finally {
      setIsLoading(false);
    }
      ...
      {plan && (
        <div className="space-y-4">
          <div className="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
            ...
            <div className="text-sm text-purple-600 dark:text-purple-300">
              {plan.steps.length} steps • {plan.estimated_time} •{" "}
              {plan.success_probability}% success rate
            </div>
          </div>
      ...
      {result && (
        <div className="space-y-4">
          <div className="p-4 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg">
            ...
            <div className="text-sm text-green-600 dark:text-green-300">
              Found {result.interactive_elements?.length || 0} interactive
              elements
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-4">
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              ...
              <div>
                ...
                <p className="font-medium text-gray-900 dark:text-white">
                  {result.interactive_elements?.filter(
                    (el: any) => el.tag === "form",
                  ).length || 0}
                </p>
              </div>
