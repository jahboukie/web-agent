...
from app.security.zero_trust import zero_trust_engine, TrustLevel, DeviceFingerprint
...
class TestZeroTrustIntegration:
    ...
    async def test_trust_score_calculation(self):
        ...
        access_context = AccessContext(
            ...
            geolocation={"country": "US", "city": "San Francisco", "latitude": 37.7749, "longitude": -122.4194},
        ...
        print(f"✅ Trust Assessment: Score={assessment.trust_score:.2f}, Level={assessment.trust_level.value}")
    ...
    async def test_siem_provider_status(self):
        ...
        try:
            ...
            for provider_id, provider_status in status.items():
                ...
                print(f"  - {provider_id}: {provider_status['provider']} ({'healthy' if provider_status['healthy'] else 'unhealthy'})")
...
class TestIntegratedWorkflow:
    ...
    async def test_complete_security_workflow(self):
        ...
        security_event = SecurityEvent(
            ...
            event_type="access_granted" if trust_assessment.trust_score > 0.6 else "access_denied",
            severity=ThreatLevel.LOW if trust_assessment.trust_score > 0.8 else ThreatLevel.MEDIUM,
            user_id=1,
            ...
            threat_indicators=[factor.value for factor in trust_assessment.risk_factors],
        ...
        try:
            ...
            print(f"  3. SIEM Integration: {str(e)} (Expected without SIEM configuration)")
