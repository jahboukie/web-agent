...
def main():
    ...
    checks = [
        ...
        # Basic file checks
        ("python -c \"import os; assert os.path.exists('app/main.py'), 'Main app file missing'\"", "File structure check"),
        
        # Database models import
        ("python -c \"from app.models.user import User; print('Models import OK')\"", "Database models check"),
        
        # API endpoints import
        ("python -c \"from app.api.v1.router import api_router; print('API router OK')\"", "API endpoints check"),
    ]
